...
= 2.2 - May 20 2022 =
* Add: Support for WP Team Pro[https://shapedplugin.com/plugin/wp-team-pro/]
* Fix: JS error on main functions.js
* Fix: Style of Drop cap in Paragraph Block
* Fix: Style of Button Block
* Fix: Style of Quote Block
* Fix: Style for Code Block

= 2.1.4 - Feb 02 2022 =
* WP 5.9 compatibility

= 2.1.3 - Jan 26 2022 =
* Fix: Admin Theme Page layout CSS

= 2.1.2 - Jan 12 2022 =
* Fix: Header Elements responsive CSS

= 2.1.1 - Jan 10 2022 =
* Fix: Signify Photography - Header Media Title responsive font size

= 2.1 - Sep 30 2021 =
* Add: Support for Block-based Widgets Editor
* Add: Widget title style to first H2 tag inside Widget Group Block
* Add: Photography image 3:2 ratio image
...
* PHP files
	...
	Source: https://raw.githubusercontent.com/WPTT/font-loader/master/wptt-webfont-loader.php

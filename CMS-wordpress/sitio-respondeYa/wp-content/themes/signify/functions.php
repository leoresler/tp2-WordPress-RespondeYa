...
if (! function_exists('signify_setup')) :
	...
	function signify_setup()
	{
		...
		// Used in Photography 3:2 ratio
		add_image_size('signify-photography', 507, 338, true);

		// Used in promotion headline
		add_image_size('signify-promotion-headline', 920, 690, true);

 ...
 */
function eduna_lms_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function eduna_lms_sanitize_css( $css ) {
 ...
 */
function eduna_lms_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function eduna_lms_sanitize_image( $input, $setting ) {
	return esc_url_raw( eduna_lms_validate_image( $input, $setting->default ) );
}
...
function eduna_lms_validate_image( $input, $default = '' ) {
 ...
 */
function eduna_lms_sanitize_number_absint( $number, $setting ) {
 ...
 */
function eduna_lms_sanitize_select( $input, $setting ) {
 ...
 * @return int
 */
function eduna_lms_sanitize_category($input){
	$output=intval($input);
	return $output;
}

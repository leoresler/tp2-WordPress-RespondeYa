...
class Ays_Quiz_Maker_Extra_Shortcodes_Public
{
    ...
    */
    ...
    public function ays_generate_quiz_avg_rate_method($attr){
    ...
    public function ays_quiz_avg_rate_html($id){

        $results = $this->ays_quiz_get_avg_rate($id);
        ...
        $avg_score = (isset( $results ) && $results != '') ? round( $results, 1 ) : 0;

        $content_html[] = "<span class='". $this->html_name_prefix ."avg-rate' id='". $this->html_name_prefix ."avg-rate-". $this->unique_id_in_class ."' data-id='". $this->unique_id ."'>";
            $content_html[] = $avg_score;
        $content_html[] = "</span>";
    ...
    public static function ays_quiz_get_avg_rate($id){
        global $wpdb;
        $id = absint($id);
    ...
    */
    ...
    public function ays_generate_all_questions_count_method(){
    ...
    public function ays_quiz_all_questions_count_html(){

        $results = $this->ays_quiz_get_all_questions_count();
        $content_html = array();
        ...
        $results_count = (isset( $results['res_count'] ) && $results['res_count'] != '') ? sanitize_text_field( $results['res_count'] ) : 0;
        ...
        $content_html[] = "<span class='". $this->html_name_prefix ."questions-count' id='". $this->html_name_prefix ."questions-". $this->unique_id_in_class ."' data-id='". $this->unique_id ."'>";
    ...
    public static function ays_quiz_get_all_questions_count(){
        global $wpdb;

        $sql = "SELECT count(*) as res_count FROM {$wpdb->prefix}aysquiz_questions";

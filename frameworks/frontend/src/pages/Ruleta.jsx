...
export default function Ruleta() {
    ...
    // ⬇️ nuevo: “tick” cada 1s para refrescar el contador en pantalla
    useEffect(() => {
        const tick = () => {
            const last = Number(localStorage.getItem(spinKey) || 0);
            const now = Date.now();
    ...
    const guardarPuntaje = async (userId, puntosGanados) => {
        try {
            await axios.put(`http://localhost:3006/users/${userId}`, { puntaje: puntosGanados });
        } catch (err) {
        ...
        <div>
            ...
            <div className="plafon">
                ...
                <div className="central">
                    <img src="/puntero.png" alt="puntero" />
                </div>
                ...
                <div
                    className='ruleta'
                    style={{
                        backgroundImage: `url('/ruleta.png')`,
